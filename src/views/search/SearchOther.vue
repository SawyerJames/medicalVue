<template>
    <div class="search-other">
        ...
        <smallUser></smallUser>
        <!-- 用户缴费信息查询 -->
        <div class="search-other-title flexRow">
            <span>用户缴费信息</span>
        </div>
        <!-- 缴费信息 -->
        <div class="search-other-msg flexCol">
            ...
            <div class="search-model flexRow">
                ...
                <span class="search-model-msg">{{search.payment_amount}}元</span>
            </div>
            <div class="search-model flexRow">
                <span class="search-model-title">统筹区</span>
            ...
            <div class="search-model flexRow">
                ...
                <span class="search-model-msg">{{search.years}}年</span>
            </div>
            <div class="search-model flexRow">
                <span class="search-model-title">待遇截至日期</span>
...
export default {
    ...
    activated() {
        document.title = "用户缴费信息查询";
        this.$nextTick(function() {
            var that = this;
            this.$tools.GetDataFromServer(
                this,
                this.API.searchOther,
